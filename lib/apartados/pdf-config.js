const DEFAULT_APARTADOS_PDF_FOLDER_ID = "1y3l0r-4XnSsicnuSeVaATSh3rC89j-If";

export const APARTADOS_PDF_FOLDER_ID = String(
  process.env.APARTADOS_PDF_SHARED_FOLDER_ID
  || process.env.APARTADOS_PDF_FOLDER_ID
  || DEFAULT_APARTADOS_PDF_FOLDER_ID,
).trim();
