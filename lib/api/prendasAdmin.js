...
const EDITABLE_COLUMNS = ["Descripción", "Tipo", "Color", "Talla", "Proveedor", "Precio", "Costo", "Margen", "Utilidad", "Existencia", "Status", "Disponibilidad", "Fecha", "TN", "InventorySource", "LastInventorySyncAt"];
const EDITABLE_UPDATE_COLUMNS = ["Descripción", "Precio", "Costo", "Status", "Disponibilidad", "Existencia"];
const NUMERIC_COLUMNS = new Set(["Precio", "Costo", "Margen", "Utilidad", "Existencia"]);
